...
<img src="<?php echo e(asset('images/loader2.gif')); ?>" style="height:25px;width:25px;" align="center"/></div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <span id="loader_cst" class="success" style="display:none;"><img src="<?php echo e(asset('images/loader.gif')); ?>" style="max-height:25px; max-width:25px;margin-left:10%;"></span>
