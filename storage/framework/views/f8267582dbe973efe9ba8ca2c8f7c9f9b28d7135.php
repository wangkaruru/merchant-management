         ...
         <li >
            ...
            <?php endif; ?> 
             ...
             <li data-toggle="collapse" data-target="#agt" class="collapsed ">
                <a href="#"><i class="fa fa-user"></i><?php echo e(@$configs_text['menu5']['menuText']); ?><span class="arrow"></span></a>
            </li>
            ...
            <li data-toggle="collapse" data-target="#bl" class="collapsed ">
                <a href="#"><i class="fa fa-user"></i><?php echo e(@$configs_text['menu7']['menuText']); ?><span class="arrow"></span></a>
            </li> 
            ...
            <li data-toggle="collapse" data-target="#dsb" class="collapsed ">
                <a href="#"><i class="fa fa-share-alt"></i>Disbursements<span class="arrow"></span></a>
            </li> 
             <ul class="sub-menu collapse" id="dsb">
