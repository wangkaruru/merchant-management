...
<div class=" row  padded-md">
 <span class="pull-left  "><h5>Customer Account</h5> </span>
...
<br>
<span class="pull-left  "><h6 class="font-open success"> <u>Recent Customer Account Transactions</u></h6> </span>
...
function get_details(){
    ...
    $('#loader').show();
     ...
     var pdata = { 
       ...
       $.ajax({
               type:'POST',
               url:'<?php  echo url("/get_customer_acc_details"); ?>',
               data:pdata,
