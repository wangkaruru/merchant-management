...
<div class=" row  padded-md">
 <span class="pull-left  "><h5><?php echo e(@$configs_text['agent1']['menuText']); ?></h5> </span>
...
<span id="loader" class="success"  align="center" style="display:none;"><img src="<?php echo e(asset('images/loading.gif')); ?>" style="max-height:25px; max-width:25px;margin-left:10%;"><small></small></span>
 ...
 <table class="table table-bordered table-striped" style="background-color:#fff; color:#363636;" >
           <tr class="font-open font-small"  >            
             <th><?php echo e(@$configs_text['agent2']['menuText']); ?></th>
             <th><?php echo e(@$configs_text['agent3']['menuText']); ?></th>
           </tr>   
      <tbody id="recent_table" class="font-open font-small">
       
           <tr class="font-open font-small"  >            
             <td><?php echo e(@$configs_text['agent4']['menuText']); ?></td>
...
<!-- recent transactions -->
<br>
<span class="pull-left  "><h6 class="font-open success"> <u>Recent Agent Account Transactions</u></h6> </span>
...
function get_details(){
    ...
    $('#loader').show();
     ...
     var pdata = { 
       ...
       $.ajax({
               type:'POST',
               url:'<?php  echo url("/get_agent_acc_details"); ?>',
               data:pdata,
